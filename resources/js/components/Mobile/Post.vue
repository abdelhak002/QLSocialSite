  ...
  <div class="bg-white border">
    <div class="flex flex-row justify-between items-center">
      <div class="flex justify-start items-center pt-2 px-4 space-x-2">
        <a class href>
          <img class="w-12 rounded-full" src="/img/logo.png" alt="tree" />
        </a>
        <div class="flex flex-col -space-y-1">
          <a class="text-sm hover:underline" href>
            <h4>abdelahk</h4>
          </a>
          <a class="hover:underline text-xs" href>
            <small>24 m</small>
          </a>
        </div>
      </div>
      <div class="hidden relative items-center">
        <button
          @click="isOpen = !isOpen"
    ...
    <div class="px-4 py-2 text-sm">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, asperiores.</p>
    </div>
    <div class="pt-2 pb-1">
      ...
      <div class="space-y-2 pt-4 pb-2 hidden">
